...
{
  title: "Hate Speech Detection using XLM-RoBERTa",
  desc: "Developed an AI-powered hate speech detection system using a fine-tuned XLM-RoBERTa transformer model. Built a FastAPI backend and a Chrome Extension that performs real-time Instagram comment moderation with confidence scores and REST API integration.",
  tech: [
    "Python",
    "PyTorch",
    "XLM-RoBERTa",
  ...
  github: "https://github.com/Saad-tech1606/Hate-Speech-Detection",
  demo: "",
  drive: "https://drive.google.com/file/d/17o79WJLLDy7Y7DClnxQmyJkip9QbtGQw/view?usp=sharing",
  featured: true,
  tag: "AI • NLP • Final Year Project",
},
    {
